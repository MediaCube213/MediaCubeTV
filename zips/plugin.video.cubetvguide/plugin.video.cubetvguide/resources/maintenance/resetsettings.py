...
def reset():
    ...
    AddonData = xbmc.translatePath('special://userdata/addon_data/plugin.video.cubetvguide')
    ...
    notify('Addon Reset','Reset successfully performed. Please restart guide.',os.path.join('special://home/addons', addon, 'icon.png'))##NOTIFY##  
    sys.exit()  
#
